...
// <--System-->>
    ...
    if (isset($_POST['login'])) {
        ...
        if (password_verify($password, $accounts_password)) {
            ...
            if (strcmp($accounts_type,"Admin") == 0) {
                header("location: http://www.ngcbdcinventorysystem.com/Admin/dashboard.php");
                $stmt->close();                
            } else if (strcmp($accounts_type,"Materials Engineer") == 0) {
                header("location: http://www.ngcbdcinventorysystem.com/Materials%20Engineer/dashboard.php");    
                $stmt->close();                            
            } else {
                header("location: http://www.ngcbdcinventorysystem.com/View%20Only/projects.php");
                $stmt->close();                                
            }
        } else {
    ...
    if (isset($_POST['createAccount'])) {
        ...
        header("location: http://www.ngcbdcinventorysystem.com/Admin/accountcreation.php");  
    }
...
// <--Admin-->
    if (isset($_POST['disableAccount'])) {
        ...
        $stmt->execute();
        $stmt->close();
        header("Location:http://www.ngcbdcinventorysystem.com/Admin/listofaccounts.php");     
    }   
    ...
    if (isset($_POST['requestAccept'])) {
        ...
        header("location: http://www.ngcbdcinventorysystem.com/Admin/passwordrequest.php");  
    }
    ...
    if (isset($_POST['delete_projmateng'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO logs (logs_datetime, logs_activity, logs_logsOf) VALUES (?, ?, ?);");
        $stmt->bind_param("ssi", $date_today, $logs_message, $logs_of);
        $logs_message = 'Removedd User ID '.$name.' from Project '.$projects_name;
        $logs_of = $accounts_id;
        $stmt->execute();
        $stmt->close();
        }
        header("Location:http://www.ngcbdcinventorysystem.com/Admin/projects.php");     
    }
...
// <--Materials Engineer-->
    ...
    if (isset($_POST['curGenerateReport'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/curGenerateReport.php");  
    }
    ...
    if (isset($_POST['viewStockCard'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/stockcard.php");  
    ...
    if (isset($_POST['reconciliation_edit'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/reconciliation.php");  
    }
    ...
    if (isset($_POST['create_disposalSlip'])) {
        ...
        $stmt->execute();
        $stmt->close();
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/disposalslip.php");     
    }
    ...
    if (isset($_POST['create_category'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/addingOfNewMaterials.php");     
    }
    ...
    if (isset($_POST['create_requisitionSlip'])) {
        ...
        $stmt->execute();
        $stmt->close();
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/viewTransactions.php");     
    }
    ...
    if (isset($_POST['create_hauling'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/hauleditems.php");
    }
    ...
    if (isset($_POST['update_account'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/account.php");     
    }
    ...
    if (isset($_POST['edit_threshold'])) {
        ...
        $stmt->execute();
        $stmt->close();
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/addMaterials.php");     
    }
    ...
    if (isset($_POST['open_returns'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/returnHauledMaterial.php");     
    }
    ...
    if (isset($_POST['view_hauling'])) {
        ...
        if (strcmp($row[0], "Materials Engineer") == 0) {
            header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/viewhaulingreceipt.php");     
        } else {
            header("location: http://www.ngcbdcinventorysystem.com/View%20Only/viewhaulingreceipt.php");  
        }  
    }
    ...
    if (isset($_POST['open_deliveredin'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/viewdeliveredin.php");     
    }
    ...
    if (isset($_POST['open_requisition'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/viewrequisitionslip.php?requisition_no=$req_no&requisition_id=$req_id");     
    }
    ...
    if (isset($_POST['adding_materials'])) {
        ...
        header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/addmaterials.php?projects_id=$project");
    }
    ...
    if (isset($_POST['update_todo_all'])) {
        ...
        header("location: http://www.ngcbdcinventorysystem.com/Materials%20Engineer/viewalltasks.php");    
    }
    ...
    if (isset($_POST['viewInventory'])) {
        ...
        if (strcmp($row[0], "Materials Engineer") == 0) {
            header("location: http://www.ngcbdcinventorysystem.com/Materials%20Engineer/viewinventory.php");    
        } else {
            header("location: http://www.ngcbdcinventorysystem.com/View%20Only/viewinventory.php");    
        }
    }
    ...
    if (isset($_POST['addMaterials'])) {
        ...
        if (strcmp($row[0], "Materials Engineer") == 0) {
            ...
            header("location: http://www.ngcbdcinventorysystem.com/View%20Only/addMaterials.php");    
        }
    }
    ...
    if (isset($_POST['prevViewInventory'])) {
        ...
        session_start();
        $_SESSION['projects_id'] = $projects_id;
        header("location: http://www.ngcbdcinventorysystem.com/Materials%20Engineer/previousReportsPage.php");    
    }
    ...
    if (isset($_POST['viewPrevReport'])) {
        ...
        header("location: http://www.ngcbdcinventorysystem.com/Materials%20Engineer/viewPreviousReport.php");    
    }
    ...
    if (isset($_POST['curViewInventory'])) {
        ...
        session_start();
        $_SESSION['projects_id'] = $projects_id;
        header("location: http://www.ngcbdcinventorysystem.com/Materials%20Engineer/currentReportPage.php");    
    }
    ...
    if (isset($_POST['materialCategories'])) {
        ...
        if (strcmp($row[0], "Materials Engineer") == 0) {
            header("Location:http://www.ngcbdcinventorysystem.com/Materials%20Engineer/materialCategories.php");  
        } else {
            header("location: http://www.ngcbdcinventorysystem.com/View%20Only/materialCategories.php");  
        }    
    }
