<?php
    ...
    if (isset($_POST['create_account'])) {
        ...
        header("Location: http://ngcbdcinventorysystem.com/Admin/listofaccounts.php");
    }
    ...
    if (isset($_POST['create_project'])) {
        ...
        if(strtotime($start_date) == strtotime($end_date)) {
            header("Location: http://ngcbdcinventorysystem.com/Admin/projects.php");      
        }
    ...
    if(isset($_POST['view_inventory'])) {
        ...
        if(strcmp($account_type,'MatEng') == 0) {
            header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/viewinventory.php?projects_name=$projects_name");            
        } else {
            header("location: http://ngcbdcinventorysystem.com/View%20Only/viewinventory.php?projects_name=$projects_name");            
        }
    }
    ...
    if(isset($_POST['backsitestockcard-view-only'])) {
        $projects_name = mysqli_real_escape_string($conn, $_POST['projects_name']);
            header("location: http://ngcbdcinventorysystem.com/View%20Only/sitematerials.php?projects_name=$projects_name");            
    }
    ...
    if(isset($_POST['fillout_hauling'])) {
        $projects_name = mysqli_real_escape_string($conn, $_POST['projects_name']);
        header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/fillouthauling.php?projects_name=$projects_name");        
    }

    if(isset($_POST['open_stockcard'])) {
        $mat_name = mysqli_real_escape_string($conn, $_POST['mat_name']);
        $projects_name = mysqli_real_escape_string($conn, $_POST['projects_name']);
            header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/stockcard.php?mat_name=$mat_name&projects_name=$projects_name");
    }
    ...
    if(isset($_POST['view_open_stockcard'])) {
        ...
        if(strcmp($view_from, "projects" ) == 0) {
            header("location: http://ngcbdcinventorysystem.com/View%20Only/stockcard.php?mat_name=$mat_name&projects_name=$projects_name");
        } else if (strcmp($view_from, "categories" ) == 0) {
            header("location: http://ngcbdcinventorysystem.com/View%20Only/stockcard.php?mat_name=$mat_name&projects_name=$projects_name");
        }else {
            header("location: http://ngcbdcinventorysystem.com/View%20Only/sitestockcard.php?mat_name=$mat_name");
        }
    }
    ...
    if(isset($_POST['open_sitestockcard'])) {
        ...
        $projects_name = mysqli_real_escape_string($conn, $_POST['projects_name']);
        header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/sitestockcard.php?mat_name=$mat_name&mat_id=$mat_id");
    }
    
    if(isset($_POST['open_report'])) {
        $projects_name = mysqli_real_escape_string($conn, $_POST['projects_name']);
        header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/reportpage.php?projects_name=$projects_name");        
    }
    ...
    if(isset($_POST['view_category'])) {
        ...
        $projects_name = mysqli_real_escape_string($conn, $_POST['projects_name']);
        if(strcmp($account_type,'MatEng') == 0) {
            header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/itemcategories.php?categories_id=$categories_id&projects_name=$projects_name");            
        } else {
            header("location: http://ngcbdcinventorysystem.com/View%20Only/itemcategories.php?categories_id=$categories_id&projects_name=$projects_name");            
        }
    }
    ...
    if(isset($_POST['view_hauled'])) {
        ...
        $account_type = mysqli_real_escape_string($conn, $_POST['account_type']);
        if(strcmp($account_type,'MatEng') == 0) {
            header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/viewhaulingform.php?hauling_no=$hauling_no");            
        } else {
        header("location: http://ngcbdcinventorysystem.com/View%20Only/viewhaulingform.php?hauling_no=$hauling_no");            
        }
    }
    ...
    if (isset($_POST['create_hauling'])) {
        ...
        $stmt->execute();
        $stmt->close();
        header("Location:http://ngcbdcinventorysystem.com/Materials%20Engineer/hauleditems.php");        
    }
    ...
    if(isset($_POST['viewtodo'])) {
        ...
        header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/dashboard.php?todoOf=$todoOf");        
    }
    ...
    if(isset($_POST['edit_account'])) {
        ...
        header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/account.php");        
    }
    ...
    if(isset($_POST['todo_update'])) {
        ...
        if(strcasecmp($update_from, 'dashboard') == 0) {   
            ...
            header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/viewalltasks.php");
        }
    }
    ...
    if(isset($_POST['edit_materials'])) {
        ...
        if(strcasecmp($update_from, 'stockcard') == 0) {   
            ...
            header("Location:http://ngcbdcinventorysystem.com/Materials%20Engineer/sitematerials.php");     
        }         
    }
    ...
    if(isset($_POST['generate_report'])) {
        ...
        mysqli_query($conn, $sql); 
        header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/generate_report.php?projects_name=$projects_name");        
    }
    ...
    if(isset($_POST['generate_hauling'])) {
        ...
        mysqli_query($conn, $sql); 
        header("location: http://ngcbdcinventorysystem.com/Materials%20Engineer/generate_hauling.php?hauling_no=$hauling_no");        
    }
    ...
    if(isset($_POST['request_accept'])) {
        ...
        header("location: http://ngcbdcinventorysystem.com/Admin/passwordrequest.php");        
    }

    if(isset($_POST['delete_project'])) {
        $project_name = $_POST['project_name'];
        echo $project_name;
        $stmt = $conn->prepare("DELETE FROM projects WHERE projects_name = ?;");
